...
public class ProfileLinksFragment
    extends Fragment
               ...
               ProfileDocumentsAdapter.ItemClickListener, DcEventCenter.DcEventDelegate
{
  ...
  public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    View view = inflater.inflate(R.layout.profile_links_fragment, container, false);

    this.recyclerView = ViewUtil.findById(view, R.id.recycler_view);
    this.noMedia      = ViewUtil.findById(view, R.id.no_links);
